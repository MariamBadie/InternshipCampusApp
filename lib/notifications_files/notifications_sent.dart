...
class _NotificationsSentState extends State<NotificationsSent> {
  final List<NotificationObject> _avaliableNotifications = [
    ...
    NotificationObject(
      notficationText: 'Job Fair Alert! Discover companies and internships available next Monday!',
    ...
    NotificationObject(
      notficationText: 'Mention Alert! Salma Sayed mentioned you in a comment. See what they have to say!',
      notficationDate: DateTime.now().subtract(const Duration(days: 2)),
      notficationImg: Image.asset('assets/images/bell.png', width: 200),
    ),
    NotificationObject(
      notficationText: 'Special Offer! Enjoy discounts and special offers at Cerave Booth on campus. Don\'t miss out on the great deals!',
    ...
    NotificationObject(
      notficationText: 'You\'ve been tagged! Laila Khaled mentioned you in a post!',
      notficationDate: DateTime.now().subtract(const Duration(days: 6)),
      notficationImg: Image.asset('assets/images/bell.png', width: 200),
    ),
    NotificationObject(
      notficationText: 'Your post just got a like! Nour Khaled liked your post. Check it out!',
      notficationDate: DateTime.now().subtract(const Duration(days: 31)),
      notficationImg: Image.asset('assets/images/like.png', width: 200),
    ),
    NotificationObject(
      notficationText: 'New Booth Alert! BreadFast is opening a booth on campus in 2 days. Plan your visit!',
      notficationDate: DateTime.now().subtract(const Duration(days: 32)),
      notficationImg: Image.asset('assets/images/party-hat.png', width: 200),
    ),
    NotificationObject(
      notficationText: 'Your comment just got a like! Mariam Mohamed liked your comment!',
      notficationDate: DateTime.now().subtract(const Duration(days: 64)),
      notficationImg: Image.asset('assets/images/liked-a-comment.png', width: 200),
    ),
  ];
  ...
  Widget build(context) {
    return Scaffold(
      body: Column(
        children: [
          Expanded(
            child: NotificationsList(notif: _avaliableNotifications),
          ),
        ],
      ),
    );
