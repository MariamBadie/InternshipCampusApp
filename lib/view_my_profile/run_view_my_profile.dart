import 'package:campus_app/view_my_profile/activity_list.dart';
import 'package:campus_app/view_my_profile/profile_page.dart';
import 'package:flutter/material.dart';


class RunViewMyProfile extends StatefulWidget{
  const RunViewMyProfile({super.key});

  @override
  State<RunViewMyProfile> createState() {
    return _RunViewMyProfileState();
  }
}

class _RunViewMyProfileState extends State<RunViewMyProfile>{
  @override
